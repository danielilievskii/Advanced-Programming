package SecondMidtermExercises.Ex19_GenericMap;
...
//        Comparator<Map.Entry<K, V>> comparingByValue = Comparator.comparing(Map.Entry::getValue);
//        SortedSet<Map.Entry<K, V>> sortedSet = new TreeSet<>(comparator.reversed());
