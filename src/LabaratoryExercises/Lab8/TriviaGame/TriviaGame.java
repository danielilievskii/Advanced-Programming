package LabaratoryExercises.Lab8.TriviaGame;
...
class TrueFalseQuestion extends TriviaQuestion {
    public TrueFalseQuestion(String question, String answer, int value, int type) {
        super(question, answer, value, type);
    }
    ...
    public String toString() {
        ...
        sb.append("Enter 'T' for true or 'F' for false.");
        return sb.toString();
    }
}

class FreeRoamQuestion extends TriviaQuestion {
    public FreeRoamQuestion(String question, String answer, int value, int type) {
        super(question, answer, value, type);
    }
...
class TriviaQuestionFactory {
    public static TriviaQuestion createQuestion(String q, String a, int v, int type) {
        if(type == TriviaQuestion.FREEFORM) {
            return new FreeRoamQuestion(q, a, v, type);
        } else {
            return new TrueFalseQuestion(q, a, v, type);
        }
    }
}
...
class TriviaData {
    ...
    public void addQuestion(String q, String a, int v, int t) {
        TriviaQuestion question = TriviaQuestionFactory.createQuestion(q, a, v, t);
        data.add(question);
    }
