package FirstMidtermExercises.Ex12;
...
class EvaluatorBuilder {
    ...
    static Evaluator NoCriminalRecordAndMoreExperience = applicant -> !applicant.hasCriminalRecord() && applicant.getEmploymentYears()>=10;
